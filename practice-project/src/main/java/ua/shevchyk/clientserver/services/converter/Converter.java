package ua.shevchyk.clientserver.services.converter;
...
public class Converter {
    ...
    public static AbstractMessage convertPayloadToMessage(PacketPayload packetPayload) {
    ...
    private static Object getObject(byte[] commandBytes) {
